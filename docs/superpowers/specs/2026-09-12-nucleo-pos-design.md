...
**jornada**
- `abierta_en`, `cerrada_en` (nulo mientras abierta), `fondo_inicial`, `efectivo_contado` (nulo hasta cerrar), y totales congelados al cerrar: `total_ventas`, `total_efectivo`, `total_tarjeta`, `total_transferencia`, `total_descuentos`, `total_propinas`, `total_perdidas`, `total_egresos`, `total_abonos_recibidos`, `total_abonos_devueltos`, `efectivo_esperado`, `diferencia_efectivo`.
